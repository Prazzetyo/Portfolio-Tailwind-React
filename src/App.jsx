...
function App() {
  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between relative">
            ...
            <div className="flex items-center px-4">
              ...
              <nav
                ...
                className={`${
                  showMenu ? "" : "hidden"
                } absolute py-5 bg-white shadow-lg rounded-lg max-w-[250px] w-full right-4 top-full lg:block 
              ...
              >
                <ul className="block lg:flex">
                  <li className="group">
                    <a
                      href="#home"
                      className="text-base text-dark py-2 mx-8 lg:mx-6 flex group-hover:text-primary"
                    >
                      Beranda
                    </a>
                  </li>
        ...
        <div className="container">
          <div className="w-full px-4">
            <div className="max-w-xl mx-auto text-center mb-16">
              <h4 className="font-semibold text-lg text-primary mb-2 uppercase">
                Portfolio
              </h4>
        ...
        <div className="container">
          <div className="w-full px-4">
            <div className="max-w-xl mx-auto text-center mb-16">
              ...
              <h2 className="font-bold text-white text-3xl mb-4l">
          ...
          <div className="w-full px-4">
            <div className="flex flex-wrap items-center justify-center">
              <a
                href="#"
                className="max-w-[120px] mx-4 py-4 grayscale opacity-60
              transition duration-500 hover:grayscale-0 hover:opacity-100
              lg:mx-6 xl:mx-8"
              >
      ...
      {/* Blog Section Start */}
      <section id="blog" className="pt-36 pb-32 lg:px-8 bg-slate-100">
        <div className="w-full px-4">
          <div className="max-w-xl mx-auto text-center mb-16">
            <h4 className="font-semibold text-lg text-primary mb-2 uppercase">
              Blog
                ...
                <div className="py-8 px-6">
                  <h3>
                    <a
                      ...
                      text-dark hover:text-primary truncate"
                    >
          ...
          <form>
            <div className="w-full lg:w-2/3 lg:mx-auto">
              <div className="w-full px-4 mb-8">
                ...
                focu:ring-primary focus:ring-1 focus:border-primary"
                />
              </div>
              <div className="w-full px-4 mb-8">
                <label
              ...
              <div className="w-full px-4">
                ...
                text-white bg-primary py-3 px-8 rounded-full
                w-full hover:opacity-80 hover:shadow-lg transition duration-500"
                >
                  Kirim
                </button>
              </div>
        ...
        <div className="container">
          <div className="flex flex-wrap">
            <div className="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
              <h2 className="font-bold text-3xl text-white mb-5">WPU</h2>
